            ...
            <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white" >
              <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                  ...
                  <i class="fas fa-chart-area fa-fw me-3" to="/starred"></i><span>Starred</span></Link>
                  ...
                  <i class="fas fa-chart-area fa-fw me-3" to="/drafts"></i><span>Drafts</span>
                    </Link>
                  <Link to="/others" class="list-group-item list-group-item-action py-2 ripple">
